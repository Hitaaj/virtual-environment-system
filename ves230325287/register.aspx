<%@ Page Title="" Language="C#" MasterPageFile="~/vesmaster.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="ves230325287.register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <div class="modal-body">
        <div class="form-container">
            <fieldset>
<h3 style="color:darkblue;"><center>Tutor Registration 📝</h3><br /><br />
            <div class="mb-3">
