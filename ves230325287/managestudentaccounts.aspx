<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="managestudentaccounts.aspx.cs" Inherits="ves230325287.managestudentaccounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    <div class="container">
        <div class="table-container">
            ...
            <asp:GridView ID="gvStudents" runat="server" AutoGenerateColumns="False" OnRowCommand="gvStudents_RowCommand" CssClass="gridview">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Button ID="btnFreeze" runat="server" Text="Freeze" CommandName="Freeze" CommandArgument='<%# Eval("Student_Id") %>' CssClass="btn btnFreeze" Visible='<%# Eval("status").ToString() == "True" %>' />
                            <asp:Button ID="btnUnfreeze" runat="server" Text="Unfreeze" CommandName="Unfreeze" CommandArgument='<%# Eval("Student_Id") %>' CssClass="btn btnUnfreeze" Visible='<%# Eval("status").ToString() == "False" %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
