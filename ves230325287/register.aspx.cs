...
WebConfigurationManager.ConnectionStrings["vesDB"].ConnectionString;
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            scmd.CommandText = "select* from tbltutor where email = @em";
            ...
            if (dr.HasRows)
            {
                lblmessage.Text = "Tutor Name Already Exist, Please Choose Another";
            ...
            else
            {
                ...
                icmd.Connection = con;
                icmd.CommandText = "INSERT INTO tbltutor (firstname, lastname, email, pwd, imageurl,status)  " +
